...
export default function JourneyToday() {
  ...
  return <div className="screen"><main className="journey-page">
    ...
    <section className="journey-card"><div className="eyebrow">Meditate · Free</div><h2 className="serif">A place to pause and rest.</h2><p>Breathing, meditation, sleep and emotional support.</p><button className="journey-button" onClick={beginMeditation}>Begin meditation</button><button className="journey-button" onClick={() => hub.setTab('library')}>Open meditation library</button><button className="journey-button" onClick={() => programme.open('seven-days-home')}>Seven Days Home</button></section>
    ...
    <div className="journey-grid"><button className="journey-button" onClick={() => hub.setTab('journal')}>Open my journal</button><button className="journey-button" onClick={() => hub.setTab('profile')}>My path and plans</button></div>
  </main></div>;
}
