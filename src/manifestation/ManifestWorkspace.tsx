...
export default function ManifestWorkspace() {
  ...
  return <div className="screen"><main className="journey-page">
    ...
    <details className="journey-disclosure"><summary>Manifesting Through Water™ <small>Your complete 21-day written workshop</small></summary><PremiumPreview><WaterCourse /><details><summary>Earlier prototype journals</summary><WaterWorkbook titles={waterDays} /></details></PremiumPreview></details>
